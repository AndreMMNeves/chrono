...
O relógio de Suspeita e a escada de Discernimento sobem juntos de propósito: **ficar mais capaz e ficar mais vigiado é a mesma curva.**`,
  ...
  /* ---------------------------------------------------------------- mestre */
  {
    ...
    ancora: "s-3-5",
    extrair: { secao: "3.5" },
    resumo: `Memória é o que você foi. Vínculo é o que você é agora — e o que ele salva é outra pessoa.`,
    relacionados: ["Memórias", "Criação de personagem", "Descompressão"],
  },
  {
    nome: "A Leitura",
    pasta: "Mesa/Conduzir",
    tags: ["mestre", "missão", "estrutura"],
    ancora: "s-17-3",
    extrair: { secao: "17.3" },
    resumo: `A fase mais importante da missão, e a que mais travava mesa por não ter procedimento. Agora tem: **três Pistas**, e falhar não bloqueia — encarece.`,
    relacionados: ["A Viga", "Anomalia", "Instabilidade do Fluxo", "Estrutura de missão", "Paradoxista"],
  },
  {
    nome: "Dentro da Zona",
    pasta: "Sistema/Viagem",
    tags: ["viagem", "fantasmas"],
    ancora: "s-15-8",
    extrair: { secao: "15.8" },
    resumo: `O que acontece quando alguém entra na Zona Fantasma de verdade — e como sai.`,
    relacionados: ["A Zona Fantasma", "Fantasmas", "Ancorador", "Instabilidade Pessoal", "Ato de Âncora"],
  },
  {
    nome: "Reancoragem",
    pasta: "Sistema/Agência",
    ...
    ancora: "s-16-5",
    extrair: { secao: "16.5" },
    resumo: `Ser Devolvido tirava o jogador do jogo por duas horas. Não tira mais.`,
    relacionados: ["Instabilidade Pessoal", "Descompressão", "Favores", "A Regra das Brasas"],
  },
  {
    nome: "Gente da Agência",
    pasta: "Mundo",
    tags: ["mundo", "instituição", "npc"],
    ancora: "s-16-6",
    extrair: { secao: "16.6" },
    resumo: `Cinco nomes, para que "a Agência disse" seja sempre **alguém** que disse — e para que a Suspeita tenha rosto.`,
    relacionados: ["A Agência", "Suspeita", "Favores", "Descompressão"],
  },
  {
    nome: "A Nêmesis",
    pasta: "Bestiário",
    tags: ["inimigos", "campanha", "mestre"],
    ancora: "s-1-4",
    livro: "inimigos",
